...
const HeroBanner = () => {
  return (
    <div className="relative text-white w-full md:px-2">
      <Carousel
        autoPlay={true}
        infiniteLoop={true}
        showThumbs={false}
      ...
      >
        ...
        <div>
          <img
            ...
            className="h-[70vh] md:h-[100vh] object-cover brightness-50"
          />
        ...
        <div>
          ...
          <div className="text-left absolute top-1/2 -translate-y-[50%] left-[10px] md:left-[80px] px-2">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-200 my-24">
